...
public interface Page {
	...
	/**
	 * Return the id of this page. The id is a unique identifier for a page that can
	 * be used to look up the page on disk or determine if the page is resident in
	 * the buffer pool.
	 *
	...
	/*
	 * a transaction that wrote this page just committed it. copy current content to
	 * the before image.
	 */
